        ...
        <div class="row row-cols-1 row-cols-sm-4">
            <div class="col mb-4">
                <div class="card best-seller1">
                    <img src="images/westerndigital.png" class="card-img-top" alt="Western Digital 1TB HDD">
                    <div class="card-body">
                        <h6 class="card-title">Western Digital 1TB HDD
                            <h4 style="color: #9e1515;">PHP 2,300.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Western Digital 1TB HDD details.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Western Digital 1TB HDD details.php">
            ...
            <div class="col mb-4">
                <div class="card best-seller2">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Kingston A2000 250GB M.2 NVMe
                            <h4 style="color: #9e1515;">PHP 2,398.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Kingston A2000 250GB M.2 NVMe details.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Kingston A2000 250GB M.2 NVMe details.php">
                                <i class='fa fa-shopping-cart'></i> Add to cart
                            </a>
                        </p>
                    </div>
            ...
            <div class="col mb-4">
                <div class="card best-seller3">
                    <img src="images/barracuda.png" class="card-img-top" alt="Seagate BarraCuda 2TB HDD">
                    <div class="card-body">
                        <h6 class="card-title">Seagate BarraCuda 2TB HDD
                            <h4 style="color: #9e1515;">PHP 3,290.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Seagate BarraCuda 2TB HDD details.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Seagate BarraCuda 2TB HDD details.php">
                                <i class='fa fa-shopping-cart'></i> Add to cart
                            </a>
                        </p>
                    </div>

...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ryzen 3 3100</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/ryzen_3.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Ryzen 3 3100</h1>
                                   <p>Designed for high-performance gaming and multitasking, the Ryzen 3 3100 Quad-Core AM4 Processor from AMD has a maximum turbo frequency of 3.9 GHz and supports PCIe 4.0 bandwidth. Additionally, this processor features four cores with eight threads in an AM4 socket with 18MB of cache memory. Having four cores allows the processor to run multiple programs simultaneously without slowing down the system, while the eight threads allow a basic ordered sequence of instructions to be passed through or processed by a single CPU core. This processor also has a TDP of 65W. It is also unlocked, meaning it can be overclocked past its maximum turbo frequency. However, this is not recommended, as it will cause the processor to run much hotter. This CPU includes a Wraith Stealth cooling solution..</p>

                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 5,999.00</p>
                    <form action="Ryzen 3 3100details.php" class="form-horizontal" method="post">

...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nvidia GTX 1050ti </li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/1050ti.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Nvidia GTX 1050ti </h1>
                                   <p>Everyone deserves great gaming. That's why we created the fast, powerful GeForce® GTX 1050. Now, you can turn your PC into a true gaming rig, powered by NVIDIA Pascal™—the most advanced GPU architecture ever created. It's loaded with innovative NVIDIA Game Ready technologies that let every gamer experience the latest titles in their full glory. #GameReady.</p>

                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 9,950.00</p>
                    <form action="Nvidia GTX 1050ti details.html" class="form-horizontal" method="post">

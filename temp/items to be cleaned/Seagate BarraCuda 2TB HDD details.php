...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="storage.php">Storage</a></li>
                <li class="breadcrumb-item active" aria-current="page">Seagate BarraCuda 2TB HDD</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/barracuda.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Seagate BarraCuda 2TB HDD</h1>
                <p>Store more, compute faster, and do it confidently with the proven reliability of BarraCuda internal hard drives<br>
                    Build a powerhouse gaming computer or desktop setup with a variety of capacities and form factors<br>
                    The go to SATA hard drive solution for nearly every PC application—from music to video to photo editing to PC gaming<br>
                    Confidently rely on internal hard drive technology backed by 20 years of innovation<br>
                    Enjoy long term peace of mind with the included 2 year limited warranty<br></p>
                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 3,290.00</p>
                    <form action="Seagate BarraCuda 2TB HDD details.php" class="form-horizontal" method="post">

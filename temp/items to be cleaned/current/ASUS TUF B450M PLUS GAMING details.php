...
<body>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/asus_gaming_motherboard.jpg" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">ASUS TUF B450M PLUS GAMING</h1>
                     <p><li>Fan Xpert 2+: Ensures every fan achieves the best balance of cooling performance and acoustics<br>
                <li>TUF Protection: SafeSlot, ESD Guards, DDR4 overvoltage protection, Digi+ VRM, and stainless-steel back I/O for long-term reliability<br>
                <li>Military-grade TUF Components: TUF LANGuard, TUF Chokes, TUF Capacitors, and TUF MOSFETs for maximum durability<br>
                <li>Exclusive DTS® Custom audio: Delivers positional cues to stereo headphones, helping you to pinpoint enemies and action<br>
                <li> Aura Sync RGB: Synchronize LED lighting with a vast portfolio of compatible PC gear<br></p>
                    <form action="ASUS TUF B450M PLUS GAMING details.html" class="form-horizontal" method="post">

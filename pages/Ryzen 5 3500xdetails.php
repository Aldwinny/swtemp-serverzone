...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="processor.php">Processor</a></li>
                <li class="breadcrumb-item active" aria-current="page">Ryzen 5 3500x</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/Ryzen-5.jpg" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Ryzen 5 3500x</h1>
                     <p>The AMD Ryzen 5 3500X is a desktop processor with 6 cores, launched in September 2019. It is part of the Ryzen 5 lineup, using the Zen 2 (Matisse) architecture with Socket AM4. Ryzen 5 3500X has 32MB of L3 cache and operates at 3.6 GHz by default, but can boost up to 4.1 GHz, depending on the workload. AMD is making the Ryzen 5 3500X on a 7 nm production node using 3,800 million transistors. The silicon die of the chip is not fabricated at AMD, but at the foundry of TSMC. You may freely adjust the unlocked multiplier on Ryzen 5 3500X, which simplifies overclocking greatly, as you can easily dial in any overclocking frequency.</p>
                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 8,450.00</p>
                    <form action="Ryzen 5 3500xdetails.php" class="form-horizontal" method="post">

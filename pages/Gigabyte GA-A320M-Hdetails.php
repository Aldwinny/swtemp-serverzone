...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="motherboard.html">Motherboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Gigabyte GA-A320M-H</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/a320mh.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Gigabyte GA-A320M-H</h1>
                  <p><li>AMD 3rd Gen Ryzen™/ 2nd Gen Ryzen™/ 1st Gen Ryzen™/ 2nd Gen Ryzen™ with Radeon™ Vega Graphics/ 1st Gen Ryzen™ with Radeon™ Vega Graphics/ Athlon™ with Radeon™ Vega Graphics/ 7th Gen A-series/ Athlon X4 Processors<br></li>
                <li>Dual Channel Non-ECC Unbuffered DDR4, 2 DIMMs<br></li>
                <li>Ultra-Fast PCIe Gen3 x4 M.2 with PCIe NVMe & SATA mode support<br></li>
                <li>High Quality Audio Capacitors and Audio Noise Guard<br></li>
                <li>Realtek® Gigabit LAN with cFosSpeed Internet Accelerator Software<br></li>
                <li>Smart Fan 5 features 5 Temperature Sensors and 2 Hybrid Fan Headers<br></li>
                <li>GIGABYTE™ UEFI BIOS<br></li>
                <li>All New GIGABYTE™ APP Center, Simple and Easy Use.<br></p></li>
                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 3,180.00</p>
                    <form action="Gigabyte GA-A320M-Hdetails.html" class="form-horizontal" method="post">

...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nvidia GTX 1660</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/NvidiaGTX1660.jpg" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Nvidia GTX 1660</h1>
                                   <p>The Nvidia GeForce GTX 1660 is a mid-tier, Turing-based, desktop GPU. The GTX 1660 relies on the TU116 chip with 1,408 shader units, 48 ROPs, 88 TMUs and a 192-bit-wide memory bus (clocked at 2 GHz = 8 GHz effectively 12 GHz, bandwidth: up to 192.1 GB/s).</p>

                    <form action="Nvidia GTX 1660 details.html" class="form-horizontal" method="post">

...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">GALAX GeForce RTX 2060</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/GalaxGeforce.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">GALAX GeForce RTX 2060</h1>
                                  <p>Three high-performance heat pipes working with twin 90mm fans, the card offers quality cooling effect for the component. For better performance, the included 1 click OC feature runs a process with just 1 button that will boost the highest stable overclock settings for customers’ graphics card.</p>

                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 21,000.00</p>
                    <form action="GALAX GeForce RTX 2060 details.html" class="form-horizontal" method="post">

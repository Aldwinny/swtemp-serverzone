    ...
    <tbody>
     ...
     <?php
        ...
        while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<td>"; echo $row["nameofproduct"]; echo "</td>";
            echo "<td>"; echo $row["specs"]; echo "</td>";
...
{
	mysqli_query($link, "update table1 set brand='$_POST[nameofproduct]' where brand='$_POST[brand]'") or die(mysqlii_error($link));

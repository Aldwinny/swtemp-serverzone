...
// WARN: Weak against SQL injections
$result = mysqli_query($connection, "SELECT * FROM items WHERE category_id IN (SELECT category_id FROM categories WHERE name='$category')");
                ...
                while ($row = mysqli_fetch_array($result)) { ?>
                    <div class="col mb-4">
                        <div class="card best-seller1">
                            <img src="/assets/images/B450Mortar.jpg" class="card-img-top" alt="<?php echo $row['brand'] . ' ' . $row['name']; ?>">
                            <div class="card-body">

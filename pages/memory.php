        ...
        <div class="row row-cols-1 row-cols-sm-4">
            <div class="col mb-4">
                <div class="card best-seller1">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">HyperX Fury 8gb 2400mhz DDR4 <span class="badge badge-danger">Hot!</span>
                            <h4 style="color: #9e1515;">PHP 2,150.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="HyperX Fury 8gb 2400mhz DDR4 details.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="HyperX Fury 8gb 2400mhz DDR4 details.php">

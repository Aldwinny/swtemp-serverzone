...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Ryzen 9 3950x</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/Ryzen-9.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Ryzen 9 3950x</h1>
                    <p>16 cores and 32 processing threads, the most processing power you can get in mainstream desktop<br>
                    Can deliver ultra-fast 100+ FPS performance in the world's most popular games<br>
                    Cooler not included, liquid cooler with 280 millimeter or larger radiator recommended. Max temps: 95°C<br>
                    4.7 GHz max boost, unlocked for overclocking, 72 MB of game cache, ddr-3200 support<br>
                    For the advanced socket AM4 platform, can support PCIe 4.0 on x570 motherboards<br>
                    Base clock-3.5GHz, CMOS-TSMC 7 nano meter Finfet, PCI express version-PCIe 4.0 x16<br>
                    Total L1 Cache 1MB, Total L2 Cache 8MB and Total L3 Cache 64MB<br></p>
                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 44,950.00</p>
                    <form action="Ryzen 9 3950xdetails.php" class="form-horizontal" method="post">

...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Western Digital 1TB HDD</li>
            </ol>
        </nav>
    </div>
    ...
    <div id="details" class="container">
        <div id="productMain" class="row row-cols-1 row-cols-md-2">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/westerndigital.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col mb-4">
                <div class="box">
                    <h1 class="text-left">Western Digital 1TB HDD</h1>
                                   <p>With better technology comes bigger storage needs. High resolution photos, 4K videos, music collections, cutting edge-edge games, and other important files require a lot of storage. Handling all that media is a snap with WD Blue PC Hard Drives.</p>

                    <p style="color: #9e1515; font-size: 32px;font-weight: 400px;">PHP 2,300.00</p>
                    <form action="Western Digital 1TB HDD details.php" class="form-horizontal" method="post">

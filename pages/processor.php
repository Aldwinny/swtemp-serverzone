        ...
        <div class="row row-cols-1 row-cols-sm-4">
            <div class="col mb-4">
                <div class="card best-seller1">
                    <img src="images/Ryzen-5.jpg" class="card-img-top" alt="Ryzen 5 3500x">
                    <div class="card-body">
                        <h6 class="card-title">Ryzen 5 3500x
                            <h4 style="color: #9e1515;">PHP 8,450.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Ryzen 5 3500xdetails.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Ryzen 5 3500xdetails.php">
            ...
            <div class="col mb-4">
                <div class="card best-seller2">
                    <img src="images/ryzen_3.png" class="card-img-top" alt="Ryzen 3 3100">
                    <div class="card-body">
                        <h6 class="card-title">Ryzen 3 3100
                            <h4 style="color: #9e1515;">PHP 5,999.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Ryzen 3 3100details.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Ryzen 3 3100details.php">
                                <i class='fa fa-shopping-cart'></i> Add to cart
                            </a>
                        </p>
                    </div>
            ...
            <div class="col mb-4">
                <div class="card best-seller3">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Ryzen 9 3950x
                            <h4 style="color: #9e1515;">PHP 44,950.00</h4>
                        </h6>
                        <p class="button">
                            <a class="btn btn-sm btn-default" href="Ryzen 9 3950xdetails.php">
                                View Details
                            </a>
                            <a class="btn btn-sm btn-primary" href="Ryzen 9 3950xdetails.php">
                                <i class='fa fa-shopping-cart'></i> Add to cart
                            </a>
                        </p>
                    </div>

    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="memory.php">Memory</a></li>
                <li class="breadcrumb-item active" aria-current="page">HyperX Fury 8gb 2400mhz DDR4 </li>
            </ol>
        </nav>
    </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/HyperxFury.png" class="d-block w-100" alt="Slide 1">
                            </div>
                        </div>
                    </div>
                </div>
